...
import Seasonspl from './Seasonspl'
    ...
    <section className='w-5/6 mx-auto my-10'>
        <div className= 'relative'>
            ...
            <div className='flex justify-center relative'>
                <div className='font-display text-slate-500 text-4xl bg-white'>Find us on</div>
            </div>
            
        </div>
        
<footer class="bg-white dark:bg-gray-800 w-full py-8 mt-10">
